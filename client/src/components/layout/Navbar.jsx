...
const Navbar = () => {
  ...
  return (
    <header className={`w-full sticky top-0 z-50 transition-all duration-500 ${isScrolled ? "glass-nav shadow-lg shadow-indigo-100/30" : "bg-white/80 backdrop-blur-xl border-b border-white/60"}`}>
      {/* Top Bar */}
      <div className="max-w-7xl mx-auto px-4 py-3.5 flex items-center justify-between gap-6">
        ...
        >
          <div className="relative w-full flex items-center glass-input rounded-2xl overflow-hidden group">
            <input
              type="text"
                ...
                <AnimatePresence>
                  {isDropdownOpen && (
                    <motion.div
                      ...
                      className="absolute right-0 top-14 glass-modal rounded-2xl w-52 p-2 z-[60]"
                    >
          ...
          <ul className="hidden md:flex items-center gap-1 list-none">
            {navLinks.map((link, idx) => (
              ...
              >
                <Link
                  to={link.path}
                  className={`px-3.5 py-1.5 rounded-xl text-[12px] font-bold uppercase tracking-widest transition-all duration-250 inline-block ${
      ...
      <AnimatePresence>
        {isMobileMenuOpen && (
          <motion.div
            ...
            className="md:hidden glass-nav border-t border-white/50 overflow-hidden"
          >
            {/* Mobile Search */}
            <div className="px-4 pt-4 pb-3">
              <div className="flex items-center glass-input rounded-2xl overflow-hidden px-3">
                <input
                  type="text"
